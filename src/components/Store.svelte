...
<div class="items-grid gap-2">
	...
	{/each}
	<button type="button" onclick={addItem} class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm m-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 p-block-2">Добавить</button>
